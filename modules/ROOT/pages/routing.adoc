...
Switch back to the terminal running the load script and press kbd:[Ctrl,C] to break out of it. Then, run a script that doesn't suppress output:
...
Switch back to the terminal monitoring the v3 console and press the kbd:[Ctrl,C]
